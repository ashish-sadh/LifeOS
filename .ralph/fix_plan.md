...
- [x] `examples/thinking/`, `examples/speaking/`, `examples/writing/` — same gap: missing sessions.md, vocabulary.md, context-snapshot.md. Each example should be as complete as pole, cooking, and fitness.
