...
- [ ] Add a "Getting Started in 15 minutes" section near the top of README.md with a concrete first-coach walkthrough
- [ ] Add troubleshooting FAQ to SETUP.md (common Drive Desktop issues, connector permission errors, alias not loading, etc.)
...
- [ ] Fully populate `examples/cooking/` — add `CLAUDE.md`, `profile.md` template, and 2-3 sample recipe files showing the recipes/ folder pattern
- [ ] Fully populate `examples/thinking/` — add `CLAUDE.md`, `profile.md` template, sample decision/model files
...
- [ ] Review each `skills/*/SKILL.md` for clarity. Fix any with vague triggers or missing edge cases
- [ ] `vault-pull-inbox` skill: add explicit handling for when phone-written inbox files are malformed (missing sections, escaped markdown, etc.)
...
- [ ] Add `inbox-triage` skill — for processing Inbox.md (vault root) entries into proper homes
...
- [ ] `docs/cross-domain-power.md` — concrete worked examples of the cross-domain intelligence
